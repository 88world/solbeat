...
### Sample synthesis output (real, generated by Haiku 4.5 against BONK)
...
└────────────────────────────────────────────────────┘
      │
      ▼
Claude Haiku 4.5 synthesis (3-paragraph read + risk score)
      │
      ▼
...
| **AI** | Anthropic Claude Haiku 4.5, Perplexity Sonar Pro |
...
|---|---|---|---|
| Per cold token analysis | ~$0.046 (Sonnet 4.5, no cache) | ~$0.010 (Haiku 4.5 + Upstash) | **78%** |
| Per repeat visit | ~$0.046 | $0 (Redis hit) | **100%** |
| Estimated 43-day judging cost | $50-$200 | $1-$5 | **97%** |

Five model + caching changes drove this:
1. Switched from Claude Sonnet 4.5 to Claude Haiku 4.5 (~4x cheaper rate)
